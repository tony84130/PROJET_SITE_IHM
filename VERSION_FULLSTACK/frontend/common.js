    ...
    if (navContainer) {
        ...
        if (user) {
            ...
            document.getElementById('logout-link').addEventListener('click', (e) => {
                ...
                window.location.href = '/entete_page/connexion.html'; // Rediriger vers la page de connexion
            });
        } else {
...
// Appeler la fonction pour charger la navigation (et autres fonctions si elles existent)
document.addEventListener('DOMContentLoaded', () => {
    loadNav();
    // Ajoute ici d'autres fonctions si nécessaire (loadHeader, loadFooter, etc.)
});
